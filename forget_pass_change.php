    ...
    <form action="forget_pass_change.php" method="post" id="login_form" autocomplete="off">
        ...
        <div> <b>Change Password</b></div>
            <div>
                ...
                <input type="password" name="password" placeholder="Password must be exactly 10 characters" minlength="10" maxlength="10" required>
            </div>
            <div>
                <label for="c_password">Conform Password</label><br>
                <input type="password" name="c_password" placeholder="enter password again" minlength="10" maxlength="10" required>
            </div>
