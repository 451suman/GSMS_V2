...
<div id="right">
<form action="edit_member_list.php" method="post" class="edituser_form" height="200px"  enctype="multipart/form-data" autocomplete="off">
        <div class="form_container">
            ...
            <div>
                ...
                <input type="text" name="phone" minlength="10" maxlength="10" value="<?php echo $phone;  ?>" required><br>
            </div>
