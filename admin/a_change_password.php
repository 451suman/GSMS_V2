...
<div class="achange_pass">
    <div>
        <form action="a_change_password.php" method="post">
            Name: <?php echo $aname ?> <br>
            Old Password:  <br> 

            <input type="password" name="oldpass" id=""style="width: 280px;" placeholder="Enter Old Password" required> <br>
            New Password:  <br> 

            <input type="password" name="pass" id="" minlength="10" placeholder="Only 10 characters" style="width: 280px;" required> <br>

            Confirm Password: <br>

                <input type="password" name="c_pass" minlength="10" placeholder="Only 10 characters" id="" style="width: 280px;" required> <br>
