...
<div class="adminprofile">
        <div class="aform_container">
            ...
            <div>
                ...
                <input type="text" name="name" maxlength="20"  value="<?php echo $n; ?>" class="profile_inp"  readonly><br>
            </div>
            
            <div>
                <label for="phone">Phone no.</label><br>
                <input type="text" name="phone" maxlength="10" minlength="10" value="<?php echo $p;  ?>" class="profile_inp"  readonly><br>
            </div>
